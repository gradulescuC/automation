...
"""
sleep= metoda prin care punem in cod timp de o perioada bine definita care va fi respectata ad-literam de catre sistem
implicitly_wait()= metoda prin care sistemul va cauta un element timp de o perioada determinata
                   daca elementul este gasit mai devreme, atunci va executa urmatoare instructiune fara sa mai astepte
