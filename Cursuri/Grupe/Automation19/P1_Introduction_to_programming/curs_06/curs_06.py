...
print("Instructiune aflata in afara if-ului - main")

if __name__ == "__main__":
    instanta_masina4 = Masina("Volkswagen","Golf","Negru")
    instanta_masina5 = Masina("BMW","X5","Orange")
    print(instanta_masina4.model, instanta_masina4.culoare)
    print(instanta_masina5.model, instanta_masina5.culoare)
    print("Instructiune aflata in interiorul if-ului - main")
...
# print(instanta_masina_bmw.consum_viteza_max)
# print(instanta_masina_bmw.viteza_max)
# instanta_masina_bmw.calcul_consum_max()
# print(instanta_masina_bmw.consum_viteza_max)
#
lista_masini = [instanta_masina_bmw,instanta_masina_volkswagen,instanta_masina_golf]
for masina in lista_masini:
    masina.calcul_consum_max()
    print(f"Masina {masina.model} poate atinge o viteza maxima de  {masina.viteza_max} la care va consuma {masina.consum_viteza_max}")
