...
# completam username
chrome.find_element(By.ID, 'username').send_keys('tomsmith123')
sleep(3)
...
# verificam mesajul de eroare (user gresit)
expected_msg = chrome.find_element(By.XPATH, '//div[@id="flash"]').text
assert expected_msg.__contains__('Your username is invalid!')
